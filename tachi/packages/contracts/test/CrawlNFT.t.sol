...
contract CrawlNFTTest is Test {
    ...
    function testCannotMintToZeroAddress() public {
        vm.expectRevert("CrawlNFT: Cannot mint to zero address");
        crawlNFT.mintLicense(address(0), TERMS_URI_1);
    }
    
    function testCannotMintWithEmptyTermsURI() public {
        vm.expectRevert("CrawlNFT: Terms URI cannot be empty");
    ...
    function testCannotMintDuplicateLicense() public {
        ...
        vm.expectRevert("CrawlNFT: Publisher already has a license");
    ...
    function testSoulboundTransferRestrictions() public {
        ...
        vm.prank(publisher1);
        vm.expectRevert("CrawlNFT: Token is soulbound and cannot be transferred");
        crawlNFT.transferFrom(publisher1, publisher2, 1);
        
        // Try safeTransferFrom - should also revert
        vm.prank(publisher1);
        vm.expectRevert("CrawlNFT: Token is soulbound and cannot be transferred");
    ...
    function testUpdateTermsURI() public {
        ...
        emit TermsURIUpdated(1, TERMS_URI_1, UPDATED_TERMS_URI);
    ...
    function testCannotUpdateNonExistentToken() public {
        vm.expectRevert("CrawlNFT: Token does not exist");
