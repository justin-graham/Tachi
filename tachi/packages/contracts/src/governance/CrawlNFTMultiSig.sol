...
contract CrawlNFTMultiSig is ERC721, AccessControl {
    ...
    event TermsURIUpdated(uint256 indexed tokenId, string oldTermsURI, string newTermsURI);
    ...
    function mintLicense(address publisher, string calldata termsURI) external onlyMultiSig returns (uint256 tokenId) {
    ...
    function updateTermsURI(uint256 tokenId, string calldata newTermsURI) external onlyMultiSig {
