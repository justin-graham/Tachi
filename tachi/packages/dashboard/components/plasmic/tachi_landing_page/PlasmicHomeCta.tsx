...
import TextInput from "../../TextInput"; // plasmic-import: tgG9Fw76NvQO/component
...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: QX-ce3m5YaQ7/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: oc49-m1kplya/icon
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: tipwXQCWEsbd/icon
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: c_u_0xdBtnyN/icon
...
function PlasmicHomeCta__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__s8S4P)}>
        <div
          className={classNames(
            projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__wRocm)}>
          <TextInput
      ...
      <div className={classNames(projectcss.all, sty.freeBox__leDf1)}>
        <SphereIcon
