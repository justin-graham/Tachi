...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: mEbWDJNOPQTG/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: wiVwMU4seRGB/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: GwHpdZZBlhgB/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__vS915)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__dA0P)}
            role={"img"}
          />
        ) : null}
      </div>
