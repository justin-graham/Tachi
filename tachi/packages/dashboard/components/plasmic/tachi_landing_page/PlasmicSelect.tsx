...
import MenuPopover from "../../MenuPopover"; // plasmic-import: xRrmL2WQv35m/component
import MenuItem from "../../MenuItem"; // plasmic-import: aqZdogGJdlBv/component
import MenuSection from "../../MenuSection"; // plasmic-import: uqspKMX-qg-6/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: zVqM5LHvNn1j/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__axa0B)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
