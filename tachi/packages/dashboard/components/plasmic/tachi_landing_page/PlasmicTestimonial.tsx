...
import Avatar from "../../Avatar"; // plasmic-import: QJm3Ul6EDh_n/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: qbNWsxXPlBD0/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: Iidl8UBjgVJa/icon
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__t1YJe)}>
        <div
          className={classNames(
            projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox___9RTCc)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
