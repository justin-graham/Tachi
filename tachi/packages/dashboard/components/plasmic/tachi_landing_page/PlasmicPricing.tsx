...
import Section from "../../Section"; // plasmic-import: ZfqLFHe6bEpe/component
import Plan from "../../Plan"; // plasmic-import: 4aSIklxX3VO3/component
import Bullet from "../../Bullet"; // plasmic-import: 67H5HTb-YeSO/component
import Button from "../../Button"; // plasmic-import: QX58X5UGGXHk/component
import Faq from "../../Faq"; // plasmic-import: jt7bkZDUbf6B/component
...
import sty from "./PlasmicPricing.module.css"; // plasmic-import: zcVRhvjmKros/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__kxaRp)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__yCpDd)}
                  price={
                    <div
                      className={classNames(
                        projectcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__y3Eic)}
                    color={"outlineBlue"}
                    submitsForm={true}
                  >
                    {"Get started"}
              ...
              <div className={classNames(projectcss.all, sty.column__vJFo9)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__unMt)}
                  description={
                    <div
                      className={classNames(
                        projectcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__p5DpM)}
                    color={"blue"}
                    submitsForm={true}
                  >
                    {"Get started"}
              ...
              <div className={classNames(projectcss.all, sty.column___71Raz)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__zvnT0)}
                  name={"Enterprise"}
                  price={
                    <div
                      className={classNames(
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button___6OwZu)}
                    color={"outlineBlue"}
                    submitsForm={true}
                  >
                    {"Get started"}
          ...
          <Section
            ...
            title={"FAQ"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__lH55Z)}>
              <Faq
                className={classNames("__wab_instance", sty.faq__yLG7)}
                slot={
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq___3InwE)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__wLukj)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
