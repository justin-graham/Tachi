...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: jt7bkZDUbf6B/css
...
function PlasmicFaq__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__gNmMs)}>
        <div className={classNames(projectcss.all, sty.freeBox___7O3Ii)}>
          <div className={classNames(projectcss.all, sty.freeBox__sd6W6)}>
            {renderPlasmicSlot({
