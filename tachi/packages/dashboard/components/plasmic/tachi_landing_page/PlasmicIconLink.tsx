...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: DVr6CD6Rqe8o/css
...
export type PlasmicIconLink__ArgsType = { icon?: React.ReactNode };
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__fWdnK)}
              role={"img"}
            />
          ),
