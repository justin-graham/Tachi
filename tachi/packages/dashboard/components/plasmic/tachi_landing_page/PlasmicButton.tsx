...
import sty from "./PlasmicButton.module.css"; // plasmic-import: QX58X5UGGXHk/css
...
export type PlasmicButton__VariantMembers = {
  ...
  shape: "rounded";
  size: "compact";
  color: "blue" | "red" | "outlineBlue" | "outlineRed" | "clear" | "tachi6";
};
export type PlasmicButton__VariantsArgs = {
  ...
  color?: SingleChoiceArg<
    "blue" | "red" | "outlineBlue" | "outlineRed" | "clear" | "tachi6"
  >;
};
    ...
    <button
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_tachi6]: hasVariant($state, "color", "tachi6"),
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ibjaf)}
                role={"img"}
              />
            ),
      ...
      >
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_tachi6]: hasVariant(
              $state,
              "color",
              "tachi6"
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ehwlw)}
                role={"img"}
              />
            ),
