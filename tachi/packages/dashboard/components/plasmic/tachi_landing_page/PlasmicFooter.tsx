...
import sty from "./PlasmicFooter.module.css"; // plasmic-import: 86B65UPoRcYg/css
...
function PlasmicFooter__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__rb4IY)} />

      <div className={classNames(projectcss.all, sty.freeBox__zk2TE)}>
        <PlasmicLink__
