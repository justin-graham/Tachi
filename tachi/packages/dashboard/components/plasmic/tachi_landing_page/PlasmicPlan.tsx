...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: 4aSIklxX3VO3/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__kfbwy)}>
        <div className={classNames(projectcss.all, sty.freeBox__t9OwE)}>
          {renderPlasmicSlot({
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__eemzn)}>
                <Bullet
                  className={classNames("__wab_instance", sty.bullet___2Mb9I)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___6Sa6N)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__eb4Oi)}
                />
              </div>
            ),
            value: args.description
          })}
          <div className={classNames(projectcss.all, sty.freeBox__mkHgM)}>
            {renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__jkOB)}
                  color={"outlineBlue"}
                  submitsForm={true}
                >
                  {"Get started"}
