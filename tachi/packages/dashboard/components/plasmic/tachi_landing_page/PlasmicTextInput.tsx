...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: tgG9Fw76NvQO/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___5RD2Q)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__w3QPv)}
              role={"img"}
            />
          ),
