...
import sty from "./PlasmicAvatar.module.css"; // plasmic-import: QJm3Ul6EDh_n/css
...
export type PlasmicAvatar__ArgsType = { pic?: React.ReactNode };
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__wwAok)}
            displayHeight={"100%"}
