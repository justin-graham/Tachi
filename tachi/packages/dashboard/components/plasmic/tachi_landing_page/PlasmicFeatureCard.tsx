...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: E_CamQzXxCls/css
...
function PlasmicFeatureCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___4Cxid, {
          [sty.freeBoxlong___4Cxid4QWl0]: hasVariant($state, "long", "long")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__qqAzg, {
            [sty.freeBoxlong__qqAzg4QWl0]: hasVariant($state, "long", "long")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___0QdH8)}
                role={"img"}
              />
            ),
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__fJfQn, {
          [sty.freeBoxlong__fJfQn4QWl0]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__lHiZr, {
          [sty.freeBoxlong__lHiZr4QWl0]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg___6Mc4Q)}
              role={"img"}
            />
          ),
