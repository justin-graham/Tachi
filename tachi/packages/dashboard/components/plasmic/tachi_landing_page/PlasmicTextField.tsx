...
import Label from "../../Label"; // plasmic-import: HOuiAaxrfFr_/component
import TextInput2 from "../../TextInput2"; // plasmic-import: GGu3w-X8de3u/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 1Rs1l7zr4yPu/component
import Description from "../../Description"; // plasmic-import: Dd2t5yh47NN2/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: R_nijpoBPDhQ/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__vq3Wo, {
          [sty.freeBoxiconEnd__vq3WoAjuq0]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__vq3WOfoLFp]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__vq3Wow2U70]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___6Yu2K, {
            [sty.freeBoxiconStart___6Yu2KfoLFp]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___6Yu2Kw2U70]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__p2Ymm)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___0Kzsh, {
            [sty.freeBoxiconEnd___0KzshAjuq0]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___0KzshfoLFp]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__knw8K)}
                role={"img"}
              />
            ),
