...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: aqZdogGJdlBv/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__cmqDd)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__aDaBu)}>
            <div
              className={classNames(
                projectcss.all,
