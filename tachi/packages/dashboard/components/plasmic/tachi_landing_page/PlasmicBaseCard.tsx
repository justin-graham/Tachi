...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: Q4GbpJs1b6iI/css
...
export type PlasmicBaseCard__VariantsArgs = {
  ...
  dashboard?: SingleBooleanChoiceArg<"dashboard">;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.dashboard
      }
    ],
    [$props, $ctx, $refs]
  );
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          [sty.rootdashboard]: hasVariant($state, "dashboard", "dashboard"),
          [sty.rootlong]: hasVariant($state, "long", "long")
        }
      )}
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___97Fqo, {
          [sty.freeBoxlong___97FqoIuKM]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__o2KZq)}
                displayHeight={"auto"}
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___6I2Sd, {
          [sty.freeBoxlong___6I2SdiuKM]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg___6IHq8)}
              role={"img"}
            />
          ),
