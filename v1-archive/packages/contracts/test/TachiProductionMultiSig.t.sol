...
import "../src/governance/TachiProductionMultiSig.sol";
...
contract TachiProductionMultiSigTest is Test {
    ...
    function setUp() public {
        ...
        multiSig =
            new TachiProductionMultiSig(signers, roles, hardwareWalletTypes, REQUIRED_SIGNATURES, TIME_LOCK_DURATION);
    }
    ...
    function testTransactionSubmission() public {
        ...
        vm.prank(signer1);
        uint256 txId = multiSig.submitTransaction(address(0x123), 0, "", "Test transaction", false);
    ...
    function testEmergencyTransactions() public {
        ...
        vm.prank(signer3);
        uint256 txId = multiSig.submitTransaction(address(0x123), 0, "", "Emergency pause", true);
    ...
    function testOwnerManagement() public view {
        ...
        (bool isActive, uint256 addedAt, uint256 lastActivity, string memory hardwareWalletType, string memory role) =
            multiSig.getOwnerInfo(signer1);
    ...
    function testTimeLock() public {
        ...
        vm.prank(signer1);
        uint256 txId = multiSig.submitTransaction(address(0x123), 0, "", "Time-locked transaction", false);
