...
contract TachiMultiSigTest is Test {
    ...
    function testSignerManagement() public {
        ...
        // Fast-forward past timelock period
        uint256 firstWarpTime = block.timestamp + 24 hours + 1;
        vm.warp(firstWarpTime);
        ...
        // Fast-forward past timelock period for the second transaction
        // Add another 24 hours + 1 from the current time
        vm.warp(firstWarpTime + 24 hours + 1);
