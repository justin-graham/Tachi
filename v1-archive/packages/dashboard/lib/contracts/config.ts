...
const baseMainnetAddresses: ContractAddresses = {
  crawlNFT: '0xc9e45f1003063826C77107A92E354fAeBeD5241c', // Deployed CrawlNFT
  paymentProcessor: '0x8B79808075f8ed2c0871A271431b3260bc0D3f70', // Deployed PaymentProcessor
  usdc: '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913' // Base USDC
}

// Base Sepolia (Chain ID: 84532)
const baseSepoliaAddresses: ContractAddresses = {
  crawlNFT: '0xE527DDaC2592FAa45884a0B78E4D377a5D3dF8cc', // Deployed CrawlNFT
  paymentProcessor: '0x7C503301eB8fA9dC7C3d2242487f18598321E479', // Deployed PaymentProcessor
